<?php
	...
	class LineChart extends BarChart {
		 ...
		 */
		var $labelY="EjeY";  // modificado por leandro.ticlia@gmail.com
		var $labelX="EjeX";  // modificado por leandro.ticlia@gmail.com
		...
		protected function printAxis() {
			...
			//dibujando los ejes de cuadro // leandro Ticlia
			$text->printText($img, $graphArea->x1+10, $graphArea->y1, new Color(0,0,255), $this->labelY, $text->fontCondensedBold ,   $text->VERTICAL_CENTER_ALIGN);
			$text->printText($img, $graphArea->x2+100, $graphArea->y2, new Color(0,0,255), $this->labelX, $text->fontCondensedBold ,   $text->HORIZONTAL_RIGHT_ALIGN);
		...
		public function setLabelY($var){
			$this->labelY=$var;
		}
		public function setLabelX($var){
			$this->labelX=$var;
		}		
